...
(function($){
	...
	$.fn.kkPages = function(options){
		...
		return this.each(function(){		
			...
			// 定义分页导航
			var PagesNavHtml = "<div class=\"Pagination\"><a href=\"javascript:;\" class=\"homePage\">First</a><a href=\"javascript:;\" class=\"PagePrev\">Prev</a><span class=\"Ellipsis\"><b>...</b></span><div class=\"pagesnum\"></div><span class=\"Ellipsis\"><b>...</b></span><a href=\"javascript:;\" class=\"PageNext\">Next</a><a href=\"javascript:;\" class=\"lastPage\">Last</a><cite class=\"FormNum\">jump to<input type=\"text\" name=\"PageNum\" id=\"PageNum\"></cite>&nbsp;&nbsp;&nbsp;<a href=\"javascript:;\" class=\"PageNumOK\">Sure</a></div>";
			...
			if($AllMth > $Mth){
					...
					var PagesMthTxt = "<span><b>"+$AllMth+"</b>items&nbsp;&nbsp;&nbsp;<b>"+PagesMth+"</b>pages</span>";
				...
				$submit.click(function(){
						...
						if($input.val() == ""){
							...
							alert("Please fill in what page you want to jump to");
							$input.focus().val("");
							return false
							
							}if($input.val() > PagesMth){
								
								alert("The page you skipped does not exist");
								$input.focus().val("");
								return false
				...
				$PagesPrev.click(function(){
						...
						if(OldNav.text() == 1){alert("Don't order any more ~ it's already on the front page.");}else{
				...
				$PagesNext.click(function(){
						...
						if(OldNav.text() == PagesMth){alert("Don't click any more ~ it's already the last page.");}else{
