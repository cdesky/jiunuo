<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Service5.aspx.cs" Inherits="QiZhanBang.Web.Service5" %>
...
<head id="Head1" runat="server">
    ...
    <style type="text/css">
        .cnt_top { overflow:hidden; height:1694px; background-image:url('images/service5_bg/1.jpg'); background-position:center top; background-repeat:no-repeat; }
