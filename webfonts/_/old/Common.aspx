<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Common.aspx.cs" Inherits="QiZhanBang.Web.Common" %>
...
<body>
	...
	<div class="clearFix pt18 der-reg-cont">
		...
		<div class="fl der-regL">
			<div class="pr mainL-tit-list">
				<h2 class="pa mainL-tit01"><b><%=categoryname1 %></b><%=categoryname2 %></h2>
				<ul class="tit-list">
                     <%=categorylist%>
                </ul>
			</div>
