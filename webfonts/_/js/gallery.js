(function (window, undefined) {
    ...
    ifeng.Gallery = function (options) {
        ...
        O.setStyle(o.thumb, "width", (tWidth + 2) + 'px'); //ie6鍏煎澧炲姞2px
        ...
        t.pageSize = (t.size % 12) == 0 ? Math.floor(t.size / 12) : Math.floor(t.size / 12) + 1; //澶у浘鏈夊灏戦〉锛岃繘琛屽垵濮嬪寲
    ...
    ifeng.Gallery.prototype = {
        ...
        showPhoto: function (id) {
            ...
            if (info.timg != t.o.photo.src || index == 1) {
                ...
                t.o.photoDesc.innerHTML = (info.morelink == '') ? info.desc : info.desc;
                ...
                t.bar.onStart = function () {
                    ...
                    if (index == 1) {
                        ...
                        o.photoPrev.title = "涓婁竴鍥鹃泦";
                    } else if (t.size == index) {
                        o.scrlNext_b.className = "no";
                        o.photoNext.title = "涓嬩竴鍥鹃泦";
                    } else {
                        o.scrlPrev_b.className = "";
                        o.scrlNext_b.className = "";
                        o.photoPrev.title = "涓婁竴寮狅紝鏀寔 '鈫� '缈婚〉";
                        o.photoNext.title = "涓嬩竴寮狅紝鏀寔 '鈫� '缈婚〉";
                    }
                    if (t.size <= 5) {
                        o.scrlPrev_b.className = "no";
                        o.scrlNext_b.className = "no";
