...
<tr>
  <td height="25" background="Images/Top.gif">
    <a class="hand" href="productedit.aspx?action=add&channelid=<%= ChannelId %>">添加产品</a>
    &nbsp;<a class="hand" href="ProductAddbBatch.aspx">批量添加产品</a>
  </td>
</tr>
</table>
...
<FooterStyle HorizontalAlign="Center" BackColor="White" Height="33px"></FooterStyle>
     ...
     <Columns>
        <asp:TemplateColumn HeaderText="选择" ItemStyle-Height="33" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="10%">
           <ItemTemplate>
              <asp:CheckBox runat="server" ID="chkIsSelect" CssClass="input" />
           </ItemTemplate>
        </asp:TemplateColumn>
        <asp:TemplateColumn HeaderText="产品图片" ItemStyle-Height="33" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="20%">
           <ItemTemplate>
              <a target="_blank" href="<%# DataBinder.Eval(Container.DataItem, "includepicpath")%>"><img src="<%# DataBinder.Eval(Container.DataItem, "includepicpath")%>" width="120" /></a>
           </ItemTemplate>
        </asp:TemplateColumn>
        ...
        <asp:TemplateColumn HeaderText="操作" ItemStyle-HorizontalAlign="Center"  HeaderStyle-Width="20%">
             <ItemTemplate>
