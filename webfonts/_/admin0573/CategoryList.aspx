<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CategoryList.aspx.cs" Inherits="QiZhanBang.Web.admin0573.CategoryList" %>
...
<form id="Form1" runat="server">
    <div>
            ...
            <tbody>
                <asp:Repeater runat="server" ID="Repeater1">
                    ...
                    <tr class="title_bg">
                        ...
                        <td align="center"><a href="CategorySubList.aspx?CateBigId=<%#Eval("categoryid") %>">子分类</a></td>
                        <td align="center"><a href="?act=edit&id=<%#Eval("categoryid")%>&channelid=<%=channelid%>">修改</a> <a href="javascript:if(confirm('确定删除吗？'))location='?act=del&id=<%#Eval("categoryid") %>'">删除</a></td>
                    </tr>
                </ItemTemplate>
                </asp:Repeater>
            </tbody>
        ...
        <input type="hidden" id="hdnchannelid" name="hdnchannelid" runat="server" />
    </div>
    </form>
</body>
</html>
